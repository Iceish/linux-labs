...
Un conseil, utilisez la commande `grep` _(lisez le manuel si vous ne connaissez pas la commande)_ pour cibler une chaîne de caractères. L'attaquant est forcément passé par le centre de contrôle sans autorisation afin de lancer son chiffrement.  
